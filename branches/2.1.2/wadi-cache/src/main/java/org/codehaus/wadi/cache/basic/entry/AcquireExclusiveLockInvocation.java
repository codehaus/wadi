 ...
 * @version $Rev:$ $Date:$
 */
public class AcquireExclusiveLockInvocation extends CacheInvocation {

    public AcquireExclusiveLockInvocation(Object sessionKey, AcquisitionInfo acquisitionInfo) {
