...
public class ContextualiserStackExplorer implements Lifecycle {
    ...
    private final List contextualisers;
    
    public ContextualiserStackExplorer() {
        contextualisers = new ArrayList();
    }

    public void pushContextualiser(Contextualiser contextualiser) {
        contextualisers.add(0, contextualiser);
    }

    public List getContextualisers() {
        return Collections.unmodifiableList(contextualisers);
    }
