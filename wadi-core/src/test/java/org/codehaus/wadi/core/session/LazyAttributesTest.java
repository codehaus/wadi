...
public class LazyAttributesTest extends RMockTestCase {
    ...
    public void testSerialization() throws Exception {
        ...
        ValueFactory valueFactory = new LazyValueFactory(valueHelperRegistry);
        LazyAttributes attributes = new LazyAttributes(valueFactory);
        ...
        LazyAttributes deserializedAttributes = new LazyAttributes(valueFactory);
