...
public class LocalPartitionMoveIMToPMActionTest extends AbstractLocalPartitionActionTest {
    ...
    public void testSuccessfulSessionRelocation() throws Exception {
        ...
        recordExchangeSendWithSM(peer2, key, timeout, correlationId, true);
    ...
    public void testSessionRelocationFails() throws Exception {
        ...
        int timeout = 10;
        String correlationId = "correlationId";
        recordExchangeSendWithSM(peer2, key, timeout, correlationId, false);
    ...
    private void recordExchangeSendWithSM(final Peer peer2,
            final String key,
            int timeout,
