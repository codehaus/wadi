...
public class PartitionBalancingInfoState implements Serializable {
    ...
    public PartitionBalancingInfoState(boolean evacuatingPartitions, PartitionBalancingInfo balancingInfo) {
        if (null == balancingInfo) {
            throw new IllegalArgumentException("balancingInfo is required");
        } else if (balancingInfo.isPrototype()) {
            throw new IllegalArgumentException("balancingInfo is a prototype");
        }
        this.evacuatingPartitions = evacuatingPartitions;
        this.balancingInfo = balancingInfo;
    }
