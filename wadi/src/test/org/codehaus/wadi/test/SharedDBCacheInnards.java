  ...
  implements CacheInnards
{
  ...
  protected final StreamingStrategy       _streamingStrategy; // can we use this ?
    ...
    throws CacheException
  {
    ...
    if (value==null)
      _log.warn("load from database failed: "+key);
    else
      _log.info("loaded from database: "+key+" : "+value);
  ...
  //----------------------------------------
  // CacheEntry - a a row in a database table
