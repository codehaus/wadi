...
public class NIOServer implements Runnable {
        ...
        protected final NIOConsumer[] _consumers; // consumers take them out and process them...
        ...
        public NIOServer(InetSocketAddress address, int bufferSize, int numConsumers) {
            ...
            _consumers=new NIOConsumer[_numConsumers];
        ...
        public synchronized void start() throws Exception {
            ...
            for (int i=0; i<_numConsumers; i++)
                (_consumers[i]=new NIOConsumer(_connections)).start();
        }
