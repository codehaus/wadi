  ...
  ContainerNotification
{
  ...
  pointcut notifySession(TomcatManager manager, HttpSessionListener listener, HttpSessionEvent event)
    : (execution(void TomcatManager.notifySessionCreated(HttpSessionListener, HttpSessionEvent)) ||
       execution(void TomcatManager.notifySessionDestroyed(HttpSessionListener, HttpSessionEvent))) &&
    args(listener, event) &&
    target(manager);

  void
    around(TomcatManager manager, HttpSessionListener listener, HttpSessionEvent event)
  ...
  pointcut notifySessionAttribute(TomcatManager manager, HttpSessionAttributeListener listener, HttpSessionBindingEvent event)
    : (execution(void TomcatManager.notifySessionAttributeAdded(HttpSessionAttributeListener, HttpSessionBindingEvent)) ||
       execution(void TomcatManager.notifySessionAttributeRemoved(HttpSessionAttributeListener, HttpSessionBindingEvent)) ||
       execution(void TomcatManager.notifySessionAttributeReplaced(HttpSessionAttributeListener, HttpSessionBindingEvent))) &&
    args(listener, event) &&
    target(manager);

  void
    around(TomcatManager manager, HttpSessionAttributeListener listener, HttpSessionBindingEvent event)
