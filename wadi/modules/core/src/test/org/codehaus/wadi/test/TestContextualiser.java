...
public class TestContextualiser extends TestCase {
    ...
    public void testExclusivePromotion() throws Exception {
        ...
        StandardManager manager=new ClusteredManager(_distributableSessionPool, _distributableAttributesFactory, _distributableValuePool, _sessionWrapperFactory, _sessionIdFactory, memory, m, _router, _streamer, _accessOnLoad, _clusterUri, _clusterName, _nodeName, _httpProxy, _httpAddress, 24);
...
//      assertTrue(memory1.contextualise(null,null,fc,"foo", null, null, false));
    ...
    public void testStack() throws Exception {
        ...
        StandardManager manager=new ClusteredManager(_distributableSessionPool, _distributableAttributesFactory, _distributableValuePool, _sessionWrapperFactory, _sessionIdFactory, stack, map, _router, _streamer, _accessOnLoad, _clusterUri, _clusterName, _nodeName, _httpProxy, _httpAddress, 24);
        manager.init(new DummyManagerConfig());
        manager.start();
        Thread.sleep(2000);
        stack.stop();
