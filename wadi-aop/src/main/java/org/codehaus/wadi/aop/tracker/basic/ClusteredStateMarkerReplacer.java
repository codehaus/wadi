...
public class ClusteredStateMarkerReplacer implements InstanceAndTrackerReplacer {
    ...
    public boolean canProcess(Object instance) {
        return instance instanceof ClusteredStateMarker || instance instanceof InstanceTracker;
    }

    public Object replaceWithTracker(Object instance, Set<InstanceTracker> trackers) {
        InstanceTracker tracker;
        if (instance instanceof InstanceTracker) {
            tracker = (InstanceTracker) instance;
        } else {
            tracker = ((ClusteredStateMarker) instance).$wadiGetTracker();
        }
    ...
    public Object replaceWithInstance(InstanceRegistry instanceRegistry, Object instance) {
        if (instance instanceof ClusteredStateMarker) {
            return instance;
        }
        String instanceId = ((InstanceTracker) instance).getInstanceId();
