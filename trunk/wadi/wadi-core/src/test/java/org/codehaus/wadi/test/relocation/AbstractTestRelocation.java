...
public class AbstractTestRelocation extends TestCase {
	...
	public void testSessionRelocation(Dispatcher red, Dispatcher green) throws Exception {
		...
		try {
			...
			assertTrue(stack2.getManager().contextualise(invocation, id, null, null, false));
			success=true;
