...
public class NeverMigrateStrategy implements MigrationStrategy {
	 ...
	 */
	public boolean migrateAndPromote(HttpServletRequest hreq,
			HttpServletResponse hres, FilterChain chain, String id,
			Promoter promoter, Sync promotionLock, Location location) {
		return false;
	}
