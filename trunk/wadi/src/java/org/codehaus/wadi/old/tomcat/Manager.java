...
import org.codehaus.wadi.old.Filter;
...
public class
  Manager
  extends org.codehaus.wadi.old.Manager
  implements org.apache.catalina.Manager, org.apache.catalina.Lifecycle
{
  ...
  public Session
    createSession()
  {
    return (org.codehaus.wadi.old.tomcat.HttpSessionImpl)acquireImpl(this);
  }
  ...
  protected org.codehaus.wadi.old.HttpSessionImpl createImpl(){return new HttpSessionImpl();}
  protected void destroyImpl(org.codehaus.wadi.old.HttpSessionImpl impl){} // TODO - cache later
