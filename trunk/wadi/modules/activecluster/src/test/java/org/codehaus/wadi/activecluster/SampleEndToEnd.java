...
public class SampleEndToEnd extends org.codehaus.wadi.replication.SampleEndToEnd {
    ...
    protected Dispatcher createDispatcher(String clusterName, String nodeName, long timeout) throws Exception {
        return new ActiveClusterDispatcher(clusterName, nodeName, CLUSTER_URI, timeout);
    }
