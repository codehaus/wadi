 ...
 * @version $Revision$
 */
interface ReplicaStorageRequest extends ReplicationRequestMessage {
    ResultInfo executeWithResult(ReplicaStorage storage);

    void execute(ReplicaStorage storage);
}