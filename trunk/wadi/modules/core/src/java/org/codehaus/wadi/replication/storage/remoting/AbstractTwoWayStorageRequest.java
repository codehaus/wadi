 ...
 * @version $Revision$
 */
abstract class AbstractTwoWayStorageRequest extends AbstractTwoWayMessage implements ReplicaStorageRequest {
    protected final Object key;
    
    public AbstractTwoWayStorageRequest(Object key) {
        this.key = key;
    }
